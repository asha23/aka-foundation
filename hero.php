...
<header id="homepage-hero" role="banner">
	<div class="row">
		...
		<div class="medium-6 columns end">
			<a class="download large button hide-for-small" href="https://github.com/olefredrik/Foundation">Download Foundation</a>
		</div>
	...
	<div class="row">
		...
		<?php while (have_posts()) : the_post(); ?>
			<article <?php post_class() ?> id="post-<?php the_ID(); ?>">
				...
				<?php do_action('Foundation_page_before_entry_content'); ?>
				...
				<?php do_action('Foundation_page_before_comments'); ?>
				<?php comments_template(); ?>
				<?php do_action('Foundation_page_after_comments'); ?>
			</article>
		<?php endwhile;?>
